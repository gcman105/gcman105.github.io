    ...
    <footer class="bg-white">
      <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        <div class="flex justify-center space-x-6 md:order-2">
          <a href="https://www.facebook.com/gcman105/" class="text-gray-400 hover:text-gray-500">
          ...
          <a href="https://www.instagram.com/gcman105/" class="text-gray-400 hover:text-gray-500">
          ...
          <a href="https://twitter.com/gcman105" class="text-gray-400 hover:text-gray-500">
          ...
          <a href="https://github.com/gcman105" class="text-gray-400 hover:text-gray-500">
          ...
          <a href="https://www.linkedin.com/in/gcman105/" class="text-gray-400 hover:text-gray-500">
